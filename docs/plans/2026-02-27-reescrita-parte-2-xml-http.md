# Reescrita nfse-nacional — Parte 2: XML & HTTP (Tasks 7-12)
...
> **Pré-requisito:** Parte 1 (Tasks 1-6) deve estar completa. Rodar `./vendor/bin/pest --no-coverage` antes de começar para verificar.
---
